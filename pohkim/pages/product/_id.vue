      ...
      <div class="flex flex-col md:flex-row gap-8 mb-12">
        ...
        <div class="md:w-2/5">
          ...
          <button 
            ...
            class="mt-4 w-full bg-gray-800 hover:bg-gray-700 text-white font-bold py-3 px-4 rounded flex items-center justify-center"
          >
          ...
          <!-- Trailer Modal -->
          <div v-if="showTrailer" class="fixed inset-0 bg-black bg-opacity-90 flex items-center justify-center z-50">
