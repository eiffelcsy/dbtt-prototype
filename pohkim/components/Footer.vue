    ...
    <div class="container mx-auto px-4 py-12">
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
        ...
        <div>
          ...
          <ul class="space-y-2">
            <li><a href="#" class="text-gray-400 hover:text-white transition-colors">Action & Adventure</a></li>
            <li><a href="#" class="text-gray-400 hover:text-white transition-colors">Drama & Romance</a></li>
            <li><a href="#" class="text-gray-400 hover:text-white transition-colors">Sci-Fi & Fantasy</a></li>
            <li><a href="#" class="text-gray-400 hover:text-white transition-colors">Horror & Thriller</a></li>
            <li><a href="#" class="text-gray-400 hover:text-white transition-colors">Comedy</a></li>
            <li><a href="#" class="text-gray-400 hover:text-white transition-colors">Documentary</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <p class="text-gray-400 mb-4">
            Get the latest updates on new releases, special offers, and exclusive content.
          </p>
          <form class="flex">
            <input 
              type="email" 
              placeholder="Your email address" 
              class="bg-gray-800 text-white rounded-l p-2 w-full focus:outline-none focus:ring-1 focus:ring-red-600"
            >
            <button class="bg-red-600 hover:bg-red-700 text-white px-4 py-2 rounded-r transition-colors">
              Subscribe
            </button>
          </form>
        </div>
        ...
        <div class="flex flex-col md:flex-row justify-between items-center">
          <div class="mb-4 md:mb-0">
            <p class="text-gray-400">
              &copy; {{ new Date().getFullYear() }} Pohkim Entertainment. All rights reserved.
            </p>
          </div>
